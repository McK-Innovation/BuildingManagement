    ...
    return (<>
        <ul id="myTab" role="tablist"
            ...
            <li className="nav-item flex-sm-fill">
                <NavLink id="UserPage" data-toggle="tab" to={"/users"} activeClassName = "active" role="tab" aria-controls="home" aria-selected="true"
                   className="nav-link border-0 text-uppercase font-weight-bold ">Users</NavLink>
            </li>
            <li className="nav-item flex-sm-fill">
                <NavLink id="EditUser" data-toggle="tab" to={"/edit-user"} activeClassName = "active" role="tab" aria-controls="profile"
                   aria-selected="false" className="nav-link border-0 text-uppercase font-weight-bold">Edit</NavLink>
            </li>
            <li className="nav-item flex-sm-fill">
                <NavLink id="CreateNew" data-toggle="tab" to={"/new-user"} activeClassName = "active" role="tab" aria-controls="profile"
